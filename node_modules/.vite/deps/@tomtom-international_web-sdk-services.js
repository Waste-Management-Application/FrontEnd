    ...
    !function(e, t) {
      ...
      return function() {
        var e = [, function(e2) {
          ...
          e2.exports = function(e3, t2) {
            for (var n2 = -1, r2 = null == e3 ? 0 : e3.length, o = Array(r2); ++n2 < r2; )
              o[n2] = t2(e3[n2], n2, e3);
            return o;
          };
        }, function(e2, t2, n2) {
          var r2 = n2(61), o = n2(12), i = Object.prototype, a = i.hasOwnProperty, s = i.propertyIsEnumerable, c = r2(function() {
            return arguments;
          }()) ? r2 : function(e3) {
          ...
          var u = function(e3, t3, n3) {
            ...
            const y = f - c + (h - l) / 1e4;
            if (y < 0 && void 0 === e3.clockseq && (d = d + 1 & 16383), (y < 0 || f > c) && void 0 === e3.nsecs && (h = 0), h >= 1e4)
          ...
          Object.defineProperty(t2, "__esModule", { value: true }), t2.default = function() {
            if (!n2 && (n2 = "undefined" != typeof crypto && crypto.getRandomValues && crypto.getRandomValues.bind(crypto) || "undefined" != typeof msCrypto && "function" == typeof msCrypto.getRandomValues && msCrypto.getRandomValues.bind(msCrypto), !n2))
          ...
          for (let e3 = 0; e3 < 256; ++e3)
            i.push((e3 + 256).toString(16).substr(1));
          ...
          Object.defineProperty(t2, "__esModule", { value: true }), t2.default = function(e3, t3, n3) {
            function i2(e4, i3, a2, s2) {
              if ("string" == typeof e4 && (e4 = function(e5) {
                ...
                return t4;
              }(e4)), "string" == typeof i3 && (i3 = (0, o.default)(i3)), 16 !== i3.length)
          ...
          var l = function(e3) {
            ...
            return function(e4) {
              ...
              for (let n3 = 0; n3 < t3; n3 += 8)
                r3[n3 >> 5] |= (255 & e4[n3 / 8]) << n3 % 32;
              return r3;
            }(e3), 8 * e3.length));
          };
          t2.default = l;
          ...
          var o = function(e3) {
            ...
            for (let t4 = 0; t4 < a; ++t4) {
              ...
              for (let r3 = 0; r3 < 16; ++r3)
                n3[r3] = e3[64 * t4 + 4 * r3] << 24 | e3[64 * t4 + 4 * r3 + 1] << 16 | e3[64 * t4 + 4 * r3 + 2] << 8 | e3[64 * t4 + 4 * r3 + 3];
              s[t4] = n3;
            }
            ...
            for (let e4 = 0; e4 < a; ++e4) {
              ...
              for (let t4 = 0; t4 < 16; ++t4)
                i2[t4] = s[e4][t4];
              for (let e5 = 16; e5 < 80; ++e5)
                i2[e5] = r2(i2[e5 - 3] ^ i2[e5 - 8] ^ i2[e5 - 14] ^ i2[e5 - 16], 1);
          ...
          e2.exports = function(e3) {
            if (null == e3)
              return true;
            if (s(e3) && (a(e3) || "string" == typeof e3 || "function" == typeof e3.splice || c(e3) || u(e3) || i(e3)))
              return !e3.length;
            var t3 = o(e3);
          ...
          e2.exports = function(e3) {
            ...
            for (var n3 in Object(e3))
              i.call(e3, n3) && "constructor" != n3 && t3.push(n3);
            return t3;
          };
        }, function(e2) {
        ...
        return function() {
          ...
          function P(e3, t3) {
            for (const n2 in e3)
              Object.prototype.hasOwnProperty.call(e3, n2) && (Array.isArray(e3[n2]) ? t3[n2] = e3[n2].slice(0) : "object" == typeof e3[n2] ? (t3[n2] = {}, P(e3[n2], t3[n2])) : t3[n2] = e3[n2]);
          }
          function T(e3, t3, n2) {
            var r2;
            e3[t3] = void 0 === (r2 = e3[t3]) ? {} : r2;
            for (const r3 in n2[t3])
              Object.prototype.hasOwnProperty.call(n2[t3], r3) && (e3[t3][r3] = n2[t3][r3]);
          }
          function x(e3, t3) {
            for (const n2 in t3)
          ...
          function ie(e3) {
            const t3 = parseFloat(e3);
            if (!ne(t3, -180, 180))
              throw new TypeError("an longitude <-180,180> is expected, but " + e3 + " [" + typeof e3 + "] given");
            return t3;
          }
          function ae(e3) {
            var t3;
          ...
          function fe(e3) {
            const t3 = parseFloat(e3);
            if (!ne(t3, -90, 90))
              throw new TypeError("an latitude <-90,90> is expected, but " + e3 + " [" + typeof e3 + "] given");
            return t3;
          }
          function he(e3) {
            let t3, n2;
            if (Array.isArray(e3)) {
              if (2 !== e3.length || 2 !== e3.filter(isFinite).length)
                throw new TypeError("Invalid point array in route points");
              t3 = e3[1], n2 = e3[0];
            } else {
              if (!isFinite(e3.lat) || !isFinite(e3.lon) && !isFinite(e3.lng))
                throw new TypeError("Invalid point object in route points");
              t3 = e3.lat, n2 = void 0 !== e3.lon ? e3.lon : e3.lng;
            }
            if (!("number" == typeof t3 || t3 instanceof Number) || !("number" == typeof n2 || n2 instanceof Number))
          ...
          function ye(e3, t3) {
            for (const n2 in e3)
              if (Object.prototype.hasOwnProperty.call(e3, n2)) {
                if (Object.prototype.hasOwnProperty.call(t3, n2) && Array.isArray(e3[n2].validators))
                  for (const r2 of e3[n2].validators)
                    D()(r2) && (t3[n2] = r2(t3[n2]));
                if (true === e3[n2].required && !Object.prototype.hasOwnProperty.call(t3, n2))
                  throw new Error("Missing required " + n2);
              }
          }
          function ve(e3, t3, n2, r2) {
            ...
            return function(o2) {
              ...
              if (!ne(i2, e3, t3) || r2 && !B()(i2))
                throw new TypeError(n2 + ", but " + o2 + " [" + typeof o2 + "] given");
              return i2;
            };
          }
          ...
          function me(e3, t3) {
            if (!te(e3))
              throw new TypeError('Invalid "'.concat(t3, '" parameter value.\n        Valid format: YYYY-MM-DDThh:mm:ss.SSSTZD'));
            return e3;
          }
          function we(e3) {
            if (M()(e3) && /^[a-zA-Z0-9-]{1,100}$/.test(e3))
              return e3;
          ...
          function Ee(e3) {
            const t3 = parseFloat(e3);
            if (!B()(t3) || t3 < 0)
              throw new TypeError("a natural integer (greater than or equal 0) is expected, but " + e3 + " [" + typeof e3 + "] given");
            return t3;
          }
          function Se(e3) {
            const t3 = parseFloat(e3);
            if (!B()(t3) || t3 <= 0)
              throw new TypeError("a positive integer (greater than 0) is expected, but " + e3 + " [" + typeof e3 + "] given");
            return t3;
          }
          function Oe(e3) {
          ...
          function xe(e3) {
            if (!M()(e3))
              throw new TypeError("a string is expected, but " + e3 + " [" + typeof e3 + "] given");
            return e3;
          }
          function Ie(e3) {
            if (!M()(e3) || 3 !== e3.length && 2 !== e3.length)
              throw new TypeError("a 2 or 3-characters long country name is expected, but " + e3 + " [" + typeof e3 + "] given");
            return e3;
          }
          function je(e3) {
            const t3 = Object.keys(q);
            if (!M()(e3) || t3.indexOf(e3) < 0)
              throw new TypeError("One of pre-defined language codes was expected: " + t3 + ", but " + e3 + " [" + typeof e3 + "] given");
            return e3;
          }
          function Ae(e3) {
          ...
          function Re(e3) {
            return be(e3, "List of pre-defined Fuel types names was expected,but " + e3 + " [" + typeof e3 + "] given", J);
          }
          function Ce(e3) {
          ...
          function De(e3) {
            return function(e4) {
              if (!M()(e4) || !k.test(e4))
                throw new TypeError("A point is expected, but " + e4 + " [" + typeof e4 + "] given");
            }(e3), e3;
          }
          function Ve(e3) {
          ...
          function Fe(e3) {
            ...
            for (const n2 of e3.split(","))
              if (-1 === t3.indexOf(n2))
                throw new TypeError("Entity type (".concat(t3, ") is expected, but ").concat(e3, " [").concat(typeof e3, "] given"));
            return e3;
          }
          function Ne(e3, t3) {
            return (n2) => {
              ...
              if (re(n2))
                throw new TypeError("an array is expected, but " + n2 + "  [" + typeof n2 + "] given");
          ...
          function Be(e3) {
            if (oe(re(e3), "An array of geometry objects is expected, but " + e3 + " [" + typeof e3 + "] given"), !(e3.length > 0))
              throw new TypeError("An array of geometry objects is expected, but " + e3 + " [" + typeof e3 + "] given");
          ...
          function Ge(e3) {
            if (isNaN(e3) || !B()(e3) || !(120 === e3 || e3 >= 5 && e3 <= 60))
              throw new TypeError("Invalid `waitTimeSeconds` parameter value. Must be 120 or an integer between 5 and 60.");
            return e3;
          }
          function We(e3) {
          ...
          function He(e3) {
            try {
              !function(e4) {
                if ("object" != typeof e4 || e4.constructor !== Object)
                  throw new TypeError("an object is expected, but " + e4 + "  [" + typeof e4 + "] given");
              }(e3);
              for (const t3 in e3)
                if (qe.includes(t3))
                  Ke(e3[t3]);
                  ...
                  if (!ze.includes(t3))
                    throw new TypeError("Endpoint name is expected to be one of supported values, but " + e3 + "given");
                  Qe(e3[t3]);
                }
            } catch (e4) {
          ...
          function Ke(e3) {
            if (!M()(e3))
              throw new TypeError("Invalid custom URL. A string URL is expected, ".concat(e3, " [").concat(typeof e3, "] given"));
            if (new RegExp(/(https:\/\/|http:\/\/).*/).test(e3))
              throw new TypeError("Invalid custom URL. URL without protocol (http/https) is expected, ".concat(e3, " given"));
            if (!new RegExp(/^[0-9a-zA-Z-.]+(\.tomtom\.com)(\/.*)?$/).test(e3))
              throw new TypeError("Invalid custom URL. URL in TomTom domain (*.tomtom.com) is expected, ".concat(e3, " given"));
            return e3;
          }
          function Qe(e3) {
            if (!M()(e3))
              throw new TypeError("Invalid custom query. A string URL is expected, ".concat(e3, " [").concat(typeof e3, "] given"));
            if (!new RegExp(/^\//).test(e3))
              throw new TypeError("Invalid custom query. A string starting with / is expected, ".concat(e3, " given"));
            return e3;
          }
          ...
          class Xe {
            ...
            _isSinglePoint(e3) {
              if (Array.isArray(e3))
                return 2 === e3.length && "object" != typeof e3[0];
              if (M()(e3)) {
            ...
            _convertStringPoint(e3) {
              const t3 = e3.split(",");
              if (!/^-?\d+(\.\d+)?,-?\d+(\.\d+)?$/.test(e3) || 2 !== t3.length)
                throw new Error("The point is not valid: " + e3);
          ...
          const et = new Xe(), tt = (e3) => {
            ...
            const t3 = {};
            t3.id = e3.id, Je()(e3) && Object.keys(e3).forEach((n3) => {
              ((e4, t4, n4) => {
                F()(n4) || (e4[t4] = n4);
              })(t3, n3, e3[n3]);
            });
            const n2 = ((e4, t4) => ({ type: "Feature", geometry: { type: t4, coordinates: [] }, properties: e4 }))(t3, "Point");
          ...
          class tn {
            ...
            resolve(t3) {
              var n2;
              if (void 0 !== (null === (n2 = this._customEndpoints) || void 0 === n2 ? void 0 : n2[t3]))
                return this._customEndpoints[t3];
              const r2 = e2[t3];
          ...
          class on {
            ...
            _validateFields() {
              if (null === this.validators || this.validators && !this._isArrayOfFunctions(this.validators))
                throw new Error("Validators are not an array of functions.");
              if (null === this.converters || this.converters && !this._isArrayOfFunctions(this.converters))
                throw new Error("Converters are not an array of functions.");
              if (void 0 !== this.required && "boolean" != typeof this.required)
                throw new Error("Required must be a Boolean.");
              if (this.deprecationDate && (Number.isNaN(Date.parse(this.deprecationDate)) || !rn.test(this.deprecationDate)))
          ...
          const dn = (e3, t3, n2, r2) => {
            ...
            const t3 = {};
            for (const [n2, r2] of Object.entries(e3))
              t3[n2] = new on(r2);
            return t3;
          }, hn = function(e3) {
            ...
            for (const [e4, i2] of Object.entries(r2)) {
              ...
              if (F()(r3) && i2.isRequired())
                o2.push(new Error("".concat(e4, " is a required field.")));
              else if (!F()(r3) || a2) {
          ...
          function vn(e3, t3, n2, r2) {
            ...
            if (e3.batchItems && t3.batchItems && (o2.batchItems = t3.batchItems.map((t4) => {
              ...
              if (K(t3.waitTimeSeconds), !(120 === t3.waitTimeSeconds || t3.waitTimeSeconds >= 5 && t3.waitTimeSeconds <= 60))
                throw new Error("Invalid `waitTimeSeconds` parameter value. Must be 120 or an integer between 5 and 60.");
          ...
          function An(e3, t3) {
            ...
            return Sn(Ln(e3, t3), n2).then(function() {
              var t4 = Pn(function* (t5) {
                ...
                if (!t5.ok)
                  return Promise.reject({ response: t5, data: n3 });
                if (e3._getOriginalResponse)
                  return t5;
                if ("batch" === e3.requestType && 202 === t5.status)
                  return t5.headers.location;
              ...
              if (n2.signal && true === n2.signal.aborted)
          ...
          function Un(e3, t3) {
            ...
            if (!n2)
              throw new Error("Unsupported request body type: " + e3);
          ...
          const Fn = function(e3, t3) {
            ...
            return function(e4, t4) {
              ...
              let r3;
              n3 && (Je()(n3) ? r3 = Un(n3, t4) : M()(n3) && (r3 = n3), t4.body = r3);
          ...
          let Gn = false;
          const Wn = () => Gn ? "http" : "https";
          var qn = (e3, t3) => {
            e3.protocol = e3 && e3.protocol || Wn();
            const n2 = e3.pathParameters;
            return n2 && "text" === n2.contentType ? Bn(e3, t3) : Fn(e3, t3);
          }, zn = (e3) => (e3.protocol = e3.protocol || Wn(), Nn(e3));
          function Hn(e3) {
            const t3 = e3[1];
          ...
          function ir(e3, t3) {
            return { pathParams: or(e3, er, t3), queryParams: or(e3, Jn, t3), postParams: or(e3, tr, t3), otherParams: or(e3, nr, t3), headerParams: or(e3, rr, t3) };
          }
          ...
          const Er = { key: { validators: [xe] }, trackingId: { validators: [we], application: pt, defaultValue: yt.v4 }, geometries: { validators: [function(e3) {
            if (re(e3))
              throw new TypeError("an array is expected, but " + e3 + "  [" + typeof e3 + "] given");
            return e3;
          ...
          function xr(e3) {
            const t3 = parseFloat(e3);
            if (!isFinite(t3))
              throw new TypeError("an number is expected, but " + e3 + " [" + typeof e3 + "] given");
          ...
          function jr(e3) {
            ...
            if (function(e4) {
              ...
              return [e3.lat(), e3.lng()];
            if (r2 = e3, Object.prototype.hasOwnProperty.call(r2, "lat") && (Object.prototype.hasOwnProperty.call(r2, "lon") || Object.prototype.hasOwnProperty.call(r2, "lng")))
              return [e3.lat, (t3 = e3.lon, n2 = e3.lng, void 0 === t3 ? n2 : t3)];
            var t3, n2, r2, o2;
            if (o2 = e3, Object.prototype.hasOwnProperty.call(o2, "x") && Object.prototype.hasOwnProperty.call(o2, "y"))
              return [e3.y, e3.x];
            if (function(e4) {
              return Object.prototype.hasOwnProperty.call(e4, "latitude") && Object.prototype.hasOwnProperty.call(e4, "longitude");
            }(e3))
              return [e3.latitude, e3.longitude];
          ...
          function Ar(e3) {
            ...
            if (function(e4) {
              ...
              return { minLon: e3.left, minLat: e3.bottom, maxLon: e3.right, maxLat: e3.top };
            if (function(e4) {
              return D()(e4.getWest) && D()(e4.getEast) && D()(e4.getSouth) && D()(e4.getNorth);
            }(e3))
              return { minLon: e3.getWest(), minLat: e3.getSouth(), maxLon: e3.getEast(), maxLat: e3.getNorth() };
            if (D()(e3.getNorthEast) && D()(e3.getSouthWest))
              return n2 = jr(e3.getNorthEast()), t3 = jr(e3.getSouthWest()), { minLon: t3[1], minLat: t3[0], maxLon: n2[1], maxLat: n2[0] };
            if (Array.isArray(e3) && 4 === e3.length)
              return { minLon: e3[0], minLat: e3[1], maxLon: e3[2], maxLat: e3[3] };
            if (Array.isArray(e3) && 2 === e3.length)
              return t3 = jr(e3[0]), n2 = jr(e3[1]), { minLon: t3[1], minLat: t3[0], maxLon: n2[1], maxLat: n2[0] };
            if (M()(e3) && 4 === (e3 = e3.trim().split(/\s*,\s*/)).length)
              return { minLon: parseFloat(e3[0]), minLat: parseFloat(e3[1]), maxLon: parseFloat(e3[2]), maxLat: parseFloat(e3[3]) };
          ...
          function kr(e3, t3) {
            ...
            e3 = e3.toLowerCase();
            for (const n2 in t3)
              if (Object.prototype.hasOwnProperty.call(t3, n2) && "defaultValue" !== n2 && Object.prototype.hasOwnProperty.call(t3[n2].synonyms, e3))
                return n2;
          ...
          function Lr(e3) {
            const t3 = [];
            for (const n2 in e3)
              Object.prototype.hasOwnProperty.call(e3, n2) && t3.push(Rr(e3[n2]));
            return t3;
          }
          function Dr(e3) {
            if (!M()(e3))
          ...
          function Ur(e3) {
            if (e3 && e3 instanceof Date)
              return e3.toISOString();
            if (!e3 || !M()(e3))
              throw new TypeError("Unable to cast " + e3 + " [" + typeof e3 + "] to datetime value.");
          ...
          function Fr(e3) {
            ...
            for (const n2 in e3)
              Object.prototype.hasOwnProperty.call(e3, n2) && (t3 = e3[n2], "POLYGON" === t3.type ? t3.vertices = Lr(t3.vertices) : "CIRCLE" === t3.type && (t3.position = Rr(t3.position)));
            return e3;
          }
          function Nr(e3) {
            return kr(e3, q);
          ...
          function Br(e3) {
            if (!e3)
              return [];
            if (M()(e3))
              return (e3 = e3.trim().replace(/\s*[,;]\s*/g, ",")).split(/[,;]+/);
            if (Array.isArray(e3))
              return e3;
          ...
          const zr = { key: { validators: [H] }, trackingId: { validators: [we], application: pt, defaultValue: yt.v4 }, maxDetourTime: { validators: [Te(1, 3600)], required: true }, spreadingMode: { validators: [Q(["auto"], "spreading mode")] }, route: { required: true, converters: [function(e3) {
            ...
            if (t3 = e3.points, t3 && !(Array.isArray(t3) && t3.length > 2))
              throw new TypeError("Provided route array " + t3 + " is not valid. It should be an array with at least 2 points.");
          ...
          function $r(e3) {
            if (isNaN(parseFloat(e3)) || !isFinite(e3))
              throw new Error("A value parsable to float is expected, but " + e3 + " [" + typeof e3 + "] given");
          }
          function Xr(e3) {
            const t3 = {};
            e3.forEach(function(e4) {
              const n2 = e4.split(",");
              if (2 !== n2.length)
                throw new Error("Invalid number of parameters in the pair around " + e4);
              if (0 === n2[0].trim().length)
                throw new Error("Speed value must not be empty.");
              if (0 === n2[1].trim().length)
                throw new Error("Consumption value must not be empty.");
              if ($r(n2[0]), $r(n2[1]), Object.prototype.hasOwnProperty.call(t3, parseFloat(n2[0])))
                throw new Error("Duplicate speed: " + n2[0]);
              ...
              if (e4[t4[n2 - 2]] > e4[t4[n2 - 1]])
                throw new Error("Consumption for two highest speeds should be increasing");
            }(t3);
          }
          function Yr(e3, t3) {
            if (e3.vehicleEngineType && e3.vehicleEngineType !== t3 && t3 !== Zr)
              throw new Error("Expecting vehicleEngineType set to " + t3);
          }
          function Jr(e3, t3, n2) {
            if (!e3[t3] || !e3[n2])
              throw new Error("Missing dependant parameter. Expecting both defined: " + t3 + ", " + n2);
          }
          function eo(e3) {
            if ("bicycle" === e3.travelMode || "pedestrian" === e3.travelMode)
              throw new Error("Consumption model parameters cannot be set if travelMode is set to bicycle or pedestrian");
          }
          function to(e3) {
            if (!e3.constantSpeedConsumptionInLitersPerHundredkm && !e3.constantSpeedConsumptionInkWhPerHundredkm)
          ...
          function no(e3) {
            return (t3, n2) => {
              if (null == t3)
                return;
              if (eo(n2), Yr(n2, e3), !M()(t3))
                throw new TypeError('Expecting a String like "15.2,12.2:8.0,9.0"');
              const r2 = t3.split(":");
              if (r2.length < 1 || r2.length > 25)
                throw new Error("Incorrect amount of speed-consumption pairs provided. Expecting 1-25, but got " + t3.length);
              Xr(r2);
            };
          }
          function ro(e3, t3) {
            return function(n2, r2) {
              if (n2 && (eo(r2), to(r2), Yr(r2, e3), $r(n2), n2 < 0))
                throw new Error(t3 + ": Expecting positive value");
            };
          }
          function oo(e3, t3) {
            return function(n2, r2) {
              n2 && (eo(r2), to(r2), Yr(r2, Zr), Jr(r2, e3, t3), Jr(r2, e3, "vehicleWeight"), r2.vehicleEngineType === Kr && Jr(r2, e3, "fuelEnergyDensityInMJoulesPerLiter"), function(e4, t4, n3) {
                if (e4[t4] * e4[n3] > 1)
                  throw new Error("Product of " + t4 + " and " + n3 + " cannot exceed 1");
              }(r2, e3, t3), $r(n2));
            };
          }
          function io(e3, t3) {
            return function(n2, r2) {
              n2 && (eo(r2), to(r2), Yr(r2, Qr), Jr(r2, e3, t3), $r(n2));
            };
          }
          function ao(e3, t3) {
            let n2, r2;
            if ("electric" === t3.vehicleEngineType) {
              if (n2 = t3.currentChargeInkWh, r2 = t3.energyBudgetInkWh, r2 > n2)
                throw new Error("Energy budget may not be greater than current energy.");
            } else if (n2 = t3.currentFuelInLiters, r2 = t3.fuelBudgetInLiters, r2 > n2)
          ...
          function co(e3, t3) {
            return function(n2, r2) {
              if (n2 && Object.prototype.hasOwnProperty.call(r2, t3) && O(r2[t3]))
                throw new Error(e3 + " parameter cannot be used in conjunction with " + t3);
            };
          }
          function lo(e3, t3) {
            return function(n2, r2) {
              if (n2 && !Object.prototype.hasOwnProperty.call(r2, t3))
                throw new Error(t3 + " must be specified when using with " + e3);
            };
          }
          function uo(e3, t3) {
          ...
          function po(e3, t3) {
            ...
            if ($r(n2), $r(r2), r2 < n2)
              throw new Error("consumptionInkWhPerkmAltitudeGain must be greater than recuperationInkWhPerkmAltitudeLoss");
            if (r2 > 500)
          ...
          class wo extends yo {
            constructor(e3, t3) {
              super(e3, t3), this.fields.minFuzzyLevel = { validators: [Ve], defaultValue: 1 }, this.fields.maxFuzzyLevel = { validators: [Ve], defaultValue: 2 }, this.fields.idxSet = { validators: [xe] }, this.fields.entityTypeSet = { converters: [qr, Wr], validators: [Fe] }, this.fields.sessionId = { validators: [xe] }, this.fields.clientTime = { validators: [We] }, this.fields.boundingBox = ho();
            }
          }
          function _o(e3, t3) {
          ...
          const Ro = { key: { validators: [xe] }, trackingId: { validators: [we], application: pt, defaultValue: yt.v4 }, query: { validators: [xe], required: true, application: ct }, language: { validators: [je], converters: [Nr], required: true }, limit: { validators: [Me] }, countrySet: { validators: [Ae] }, radius: { validators: [Ee] }, resultSet: { validators: [xe] }, center: { converters: [Mr], validators: [De], cast: (e3, t3) => {
            const n2 = e3.split(",");
            t3.lat = n2[0], t3.lon = n2[1];
          } }, sessionId: { validators: [xe] }, clientTime: { validators: [We] } };
          function Co(e3, t3) {
          ...
          const No = "reverseGeocode", Bo = "reverseGeocode/crossStreet", Go = { key: { validators: [xe] }, trackingId: { validators: [we], application: pt, defaultValue: yt.v4 }, language: { validators: [je] }, position: { converters: [Mr], validators: [De], required: true, application: ct }, heading: { validators: [K] }, radius: { validators: [Ee] }, protocol: { validators: [Q(["http", "https"], "protocol")] }, view: { validators: [Q(["AR", "IL", "MA", "IN", "PK", "Unified", "RU", "TR", "CN"], "view")] }, allowFreeformNewline: { validators: [_e] } }, Wo = { type: { defaultValue: No, visible: false, application: ct }, entityType: { converters: [qr, Wr], validators: [Fe] }, returnSpeedLimit: { validators: [_e] }, number: { validators: [xe] }, returnRoadUse: { validators: [_e] }, roadUse: { converters: [function(e3) {
            if (M()(e3))
              return '["' + e3.replace(/["']|^\s+|\s+$/g, "").split(/[\s,]+/).join('","') + '"]';
            if (Array.isArray(e3)) {
              for (let t3 = 0; t3 < e3.length; t3 += 1)
                e3[t3] = String(e3[t3]).replace(/["']|^\s+|\s+$/g, "");
              return '["' + e3.join('","') + '"]';
            }
            ...
            for (let r2 = 0; r2 < n2.length; r2 += 1)
              oe(t3.indexOf(n2[r2]) < 0, "Road use (" + t3 + ") is expected, but " + e3 + "  [" + typeof e3 + "] given");
            return e3;
          ...
          function zo(e3) {
            if (e3 === No)
              return Object.assign({}, Go, Wo);
            if (e3 === Bo)
              return Object.assign({}, Go, qo);
          ...
          var Zo = () => ({ extendedPostalCodesFor: { validators: [xe] }, type: { defaultValue: "geocode", application: ct }, key: { validators: [xe] }, trackingId: { validators: [we], application: pt, defaultValue: yt.v4 }, query: { validators: [xe], required: true, application: ct }, typeahead: { validators: [_e] }, limit: { validators: [Se] }, view: { validators: [Q(["AR", "IL", "MA", "IN", "PK", "Unified", "RU", "TR", "CN"], "view")] }, offset: { validators: [Ee], name: "ofs" }, language: { validators: [je] }, boundingBox: { validators: [Oe], converters: [Vr], cast: (e3, t3) => {
            ...
            e3 && (t3.limit = 1, t3.ofs = 0);
          } }, protocol: { validators: [Q(["http", "https"], "protocol")] }, timeZone: { validators: [Q(["iana"], "timeZone parameter")] }, entityTypeSet: { converters: [qr, Wr], validators: [Fe] } });
          const $o = Zo();
          function Xo(e3, t3) {
          ...
          function ti(e3, t3) {
            ...
            return mn(Jo, g, "structuredGeocode", function(e4, t4) {
              const n3 = Boolean(e4.bestResult);
              return ei(e4), o2(Jo, e4, t4).then((e5) => {
                let { data: t5, trackingId: r3 } = e5;
                return ht({ data: n3 ? t5.results[0] : t5, trackingId: r3 }, Ko);
              });
            }, function(e4, t4) {
              return e4.batchItems.forEach(ei), r2(Jo, e4, t4).then((e5) => ht(e5, Qo));
            })(e3, t3);
          }
          const ni = { key: { validators: [H] }, trackingId: { validators: [we], application: pt, defaultValue: yt.v4 }, routeType: { validators: [Q(["fastest", "shortest", "eco", "thrilling"], "route type")] }, traffic: { validators: [_e] }, avoid: { validators: [Ne(["tollRoads", "motorways", "ferries", "unpavedRoads", "carpools", "alreadyUsedRoads"], "avoid")], converters: [Br] }, departAt: { validators: [function(e3) {
            if ("now" === e3 || te(e3) && Date.now() < Date.parse(e3))
              return e3;
            ...
            if (te(e3) && Date.now() < Date.parse(e3))
              return e3;
            ...
            e3 && (eo(t3), $r(e3), to(t3), Yr(t3, "combustion"), function(e4, t4) {
              if (!(O(e4.accelerationEfficiency) && O(e4.decelerationEfficiency) && O(e4.uphillEfficiency) && O(e4.downhillEfficiency)))
                throw new Error("Efficiency parameters are required when using " + t4);
          ...
          let ri = { __all: { validators: [function(e3, t3) {
            ...
            if (0 === n2 || n2 > 1)
              throw new Error("Exactly one of fuelBudgetInLiters, energyBudgetInkWh, timeBudgetInSec and distanceBudgetInMeters must be set.");
          }, function(e3, t3) {
            const n2 = "alreadyUsedRoads";
            if ("avoid" in t3 && t3.avoid.indexOf(n2) > -1)
              throw new Error(n2 + " is not allowed value for avoid parameter in Calculate Reachable Route request.");
            if ("travelMode" in t3 && ["bicycle", "pedestrian"].indexOf(t3.travelMode) > -1)
              throw new Error(t3.travelMode + " is not allowed value for travelMode parameter in Calculate Reachable Route request.");
            if ("arriveAt" in t3)
          ...
          function ui(e3) {
            ...
            for (let r2 = 0; r2 < e3.legs.length; r2 += 1)
              n2.properties.segmentSummary.push(e3.legs[r2].summary), e3.legs[r2].points && (n2.geometry = n2.geometry || { coordinates: [] }, t3 ? (n2.geometry.type = "MultiLineString", n2.geometry.coordinates.push(li(e3.legs[r2].points))) : (n2.geometry.type = "LineString", n2.geometry.coordinates = li(e3.legs[r2].points)));
          ...
          function fi(e3) {
            ...
            return t3 && t3.length && t3.forEach((e4) => {
              ...
              if (!e4 || !e4.routes)
                return t4;
              for (let n2 = 0; n2 < e4.routes.length; n2 += 1)
                t4.features.push(ui(e4.routes[n2]));
              return t4;
            })(e3), toRouteSectionsCollection: () => ((e4) => {
              const t4 = [];
              return e4 && e4.routes ? (e4.routes.forEach((e5) => {
                const n2 = [];
                for (let t5 = 0; t5 < e5.legs.length; t5 += 1)
                  n2.push(...e5.legs[t5].points);
          ...
          let yi = { alternativeType: { validators: [Q(["anyRoute", "betterRoute"], "alternativeType")] }, locations: { validators: [function(e3) {
            ...
            if (!e3.match(r2))
              throw new TypeError("Routing location is expected. But " + e3 + " [" + typeof e3 + "] given");
            return e3;
          }], converters: [function(e3) {
            const t3 = [];
            if (M()(e3))
              return e3.split(":").map((e4) => e4.split(",").reverse().join(",")).join(":");
            if (Array.isArray(e3)) {
              Tr(e3.length < 2, "Unable to cast " + e3 + " [" + typeof e3 + "] to routing locations string"), t3.push(Rr(e3[0]));
              for (let n2 = 1; n2 < e3.length - 1; n2 += 1)
                t3.push(Cr(e3[n2]));
          ...
          const Ei = ["locations", "maxAlternatives", "instructionsType", "language", "computeBestOrder", "routeRepresentation", "vehicleHeading", "report", "callback", "minDeviationTime", "minDeviationDistance", "alternativeType", "sectionType", "supportingPoints", "allowVignette", "avoidAreas", "batchMode", "consumptionInkWhPerkmAltitudeGain", "recuperationInkWhPerkmAltitudeLoss"], Si = { validators: [function(e3) {
            ...
            return ie(e3);
          }], required: true } }, (e3) => (ye(Oi, e3), e3))] } })], converters: [function(e3) {
            return (t3) => (t3.forEach((t4) => {
              for (const n2 in t4)
                Object.prototype.hasOwnProperty.call(t4, n2) && Object.prototype.hasOwnProperty.call(e3, n2) && Array.isArray(e3[n2].converters) && e3[n2].converters.forEach((e4) => {
                  D()(e4) && (t4[n2] = e4(t4[n2]));
                });
            }), t3);
          }({ point: { converters: [function(e3) {
            return (t3) => {
              for (const n2 in t3)
                Object.prototype.hasOwnProperty.call(t3, n2) && Object.prototype.hasOwnProperty.call(e3, n2) && D()(e3[n2].converter) && (t3[n2] = e3[n2].converter(t3[n2]));
              return t3;
            };
          ...
          function Pi(e3, t3) {
            const n2 = function(e4) {
              const t4 = vi(Ei);
              t4.origins = Si, t4.destinations = Si, t4.batchMode = { application: ut }, t4.waitTimeSeconds = { application: lt, validators: [Ge] };
              const n3 = A(t4);
              return e4 instanceof Array && e4.forEach(function(e5) {
                delete n3[e5];
              }), n3;
            }(), r2 = new tn(t3), o2 = function(e4, t4) {
              return (n3, r3, o3) => {
            ...
            return mn(n2, v, "matrixRouting", (e4, t4) => o2(n2, e4, t4).then((e5) => ht(e5, _i)))(e3, t3);
          }
          ...
          const Li = { key: { validators: [H] }, trackingId: { validators: [we], application: pt, defaultValue: yt.v4 }, boundingBox: { required: true, validators: [Oe], converters: [Vr], cast: (e3, t3) => {
            ...
            const t3 = j(ee), n2 = j(e3), r2 = (e4, t4) => {
              Object.keys(e4).forEach(function(n3) {
                if (!t4.hasOwnProperty(n3) || typeof e4[n3] != typeof t4[n3])
                  throw new TypeError("Property ".concat(n3, " not matches available fields: ") + ee);
          ...
          const Vi = { basic: ["jpg", "jpeg", "png"], hybrid: ["png"], labels: ["png"] }, Mi = { layer: { validators: [Q(["basic", "hybrid", "labels"], "layers")], defaultValue: "basic" }, style: { validators: [Q(["main", "night"], "styles")], defaultValue: "main" }, format: { validators: [Q(["png", "jpg", "jpeg"], "formats")], defaultValue: "png" }, key: { validators: [H] }, zoom: { validators: [Te(0, 23)], converters: [function(e3) {
            ...
            return I(e3, Y, "Supported maps language is expected to be one of: " + Y + "), but " + e3 + " [" + typeof e3 + "] given");
          }] } };
          function Ui(e3, t3) {
            return e3 + "?" + Object.keys(Mi).reduce(function(e4, n2) {
              ...
              return void 0 !== r2 && (r2 = function(e5, t4) {
                if ("bbox" === e5)
                  t4 = (n3 = t4).minLon + "," + n3.minLat + "," + n3.maxLon + "," + n3.maxLat;
                else {
                  if ("zoom" === e5)
                    return String(parseInt(t4, 10));
                  if ("center" === e5) {
          ...
          function Fi(e3, t3) {
            ...
            return mn(Mi, y, "staticImage", function(e4) {
              return function(e5) {
                ...
                if (e5.bbox && (S(e5.width) || S(e5.height)))
          ...
          const Gi = { key: { validators: [H] }, trackingId: { validators: [we], application: pt, defaultValue: yt.v4 } };
          function Wi(e3, t3) {
            const n2 = new tn(t3), r2 = pr(n2.resolve("captionV2Endpoint"));
            return mn(Gi, y, "copyrightsCaptionV2", function(e4, t4) {
              return r2(Gi, e4, t4).then(ht);
            })(e3, t3);
          }
          function qi(e3, t3) {
            var n2 = Object.keys(e3);
