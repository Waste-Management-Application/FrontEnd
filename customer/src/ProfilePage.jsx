      ...
      <div className="h-screen w-full overflow-clip">
        <div className="h-52 bg-g3 border-none opacity-90 flex justify-center items-center">
          <div className="flex flex-col justify-center items-center">
            {/* <div className=" flex items-start w-4">
              <h1 className="text-2xl m-4 hover:cursor-pointer">x</h1>
            </div> */}
            <div>
              <img
        ...
        <div className="flex flex-col h-screen p-4 ">
          <div className="m-5">
            ...
            <h1 className="text-xl">Andrew Antwi</h1>
          </div>
          <div className="m-5">
            <h1 className="text-gray-500">Email</h1>
            <h1 className="text-xl">andrew@gmail.com</h1>
          </div>
          <div className="m-5">
            <h1 className="text-gray-500">Contact</h1>
            <h1 className="text-xl">233 4050 92300</h1>
          </div>
          <div className="m-5">
